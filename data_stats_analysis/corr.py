...
plt.show()
print("\n")
print("this is the correlation judged between whether the respondants own their own channel and whether they are interested to earn some bucks through their active channels.")
...
plt.show()
print("\n")
print("here we are judging the two things which mutually share some habits like why they use youtube and for what sort of videos they watch.")
...
plt.show()
print("\n")
print("this interprets whether they have any interest of subscribing and the appitite of watching their subscribed channel regularly.")
